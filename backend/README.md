...
## Project Structure
    ...
    ├── automated_pet_food_33383  # Django project configurations
...
1. Clone this repo and `cd automated_pet_food_33383`
...
2. Clone this repo and `cd automated_pet_food_33383`
